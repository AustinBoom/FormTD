...
public class Medium implements Difficulty{
    public static final int waveGoldModifier = 0;
    public static final int livesModifier = 0;
    public static final float sellValueModifier = 0.0f;
    public static final double enemyHealthModifier = 1;
    public static final int startGoldModifier = 0;
