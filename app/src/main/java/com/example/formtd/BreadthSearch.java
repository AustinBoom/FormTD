...
public class BreadthSearch {
    ...
    public ArrayList<Point> getUpToDatePath(){
        ...
        enemyWayPoints = new ArrayList<>();
        enemyWayPoints.add(new Point(DefenceView.grid[3][7].x, DefenceView.grid[3][7].y));
        enemyWayPoints.add(new Point(DefenceView.grid[6][11].x, DefenceView.grid[6][11].y));
